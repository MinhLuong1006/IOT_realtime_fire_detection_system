...
//LIVING
bool fireDetected2 = (smokeValue2 == 1 || (flameStatus2 == LOW && temperature2 >= 50));
...
//STORAGE
bool fireDetected3 = (smokeValue3 == 1 || flameStatus3 == LOW || temperature3 >= 70);
...
//KITCHEN
bool fireDetected4 = (smokeValue4 == 1 && flameStatus4 == LOW && temperature4 >= 80);
...
if (Firebase.RTDB.getInt(&fbData, "/real_alarm1")) {
  ...
  if (alarm1Value == 1 && previousAlarm1 == 0) {
    Serial.println("Alarm1 triggered externally!");
...
if (Firebase.RTDB.getInt(&fbData, "/real_alarm2")) {
  ...
  if (alarm2Value == 1 && previousAlarm2 == 0) {
    Serial.println("Alarm2 triggered externally!");
...
if (Firebase.RTDB.getInt(&fbData, "/real_alarm3")) {
  ...
  if (alarm3Value == 1 && previousAlarm3 == 0) {
    Serial.println("Alarm3 triggered externally!");
...
if (Firebase.RTDB.getInt(&fbData, "/real_alarm4")) {
  ...
  if (alarm4Value == 1 && previousAlarm4 == 0) {
    Serial.println("Alarm4 triggered externally!");
